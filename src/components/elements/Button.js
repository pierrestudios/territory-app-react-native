...
export const Link = props => {
  return (
    <Button
      {...props}
      baseStyle={styles["main-menu-link"]}
      textStyle={[
...
export const ButtonLink = props => {
  return (
    <Button
      {...props}
      baseStyle={styles["button-link"]}
      textStyle={[styles["button-link-text"], props.textStyle]}
    />
  );
};
...
export const ButtonHeader = props => {
  return (
    <Button
      {...props}
      baseStyle={styles["header-button"]}
      textStyle={[styles["header-button-text"], props.textStyle]}
    />
  );
};
